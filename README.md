...
- [基于 Spring AI 构建智能餐厅推荐系统：多模型集成的实践指南](https://blog.zhijun.io/posts/spring-ai-restaurant-showcase/)
- [基于 Spring AI 构建智能餐厅推荐系统：RAG 技术实战](https://blog.zhijun.io/posts/spring-ai-restaurant-showcase-rag/)
